    ...
    <div id="home">
        ...
        <!-- breadcrumb -->
            ...
            <div class="lg:flex justify-between items-center mb-6">
              <p class="text-2xl font-semibold mb-2 lg:mb-0">Good afternoon, Joe Emako!</p>
            ...
            <div class="  flex flex-wrap -mx-3 mb-20 ">
              ...
              <div class="w-1/2 xl:w-1/4 px-3">
                <div class="w-full 
shadow bg-white border text-blue-200 rounded-lg flex items-center p-6">
                  <svg class="w-16 h-16 fill-current mr-4 hidden lg:block" view
shadow="0 0 20 20">
...
shadow">
              ...
              <div class="w-full xl:w-1/3 px-3 shadow">
