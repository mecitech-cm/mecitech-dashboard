<template>
  ...
  <div
    class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-800 border-r z-30"
  ...
  >
    ...
    <div class="mt-5 px-4">
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 bg-gray-600  hover:bg-gray-100 rounded-lg cursor-pointer"
      >
      ...
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-600 rounded-lg cursor-pointer"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-6 w-6 h-6 w-6 fill-current mr-2"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
